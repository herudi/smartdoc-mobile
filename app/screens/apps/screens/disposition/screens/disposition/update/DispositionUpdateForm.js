...
import { myError, isEmptyObject } from "../../../../../../../utils/MyUtil";
...
const DispositionUpdateForm = ({
    ...
    useEffect(() => {
        if (!isEmptyObject(itemData)) {
            incomingRef.current.setValue(itemData.item_incoming.subject_letter);
            descRef.current.setValue(itemData.description);
            setItemIncoming(itemData.item_incoming);
            setShowPanelIncoming(true);
            setAssignDatas(itemData.assigns);
        }
    }, [itemData]);
...
export default DispositionUpdateForm;